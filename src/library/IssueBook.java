        ...
        ch.addMouseListener(new MouseAdapter()
              ...
              try
           {
               ...
               while(rest1.next())
               {
                   ...
                   tf3.setText(rest1.getString("quantity"));
               }
           }
           catch(Exception exx)
           {
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
           {
               ...
               {
                  String q2="insert into issuebook(BookId,bookno,bookname,studentId,studentname,studentcontact,data) values('"+id+"','"+bookno+"','"+bookname+"','"+stuid+"','"+stuname+"','"+stucont+"','"+date+"')";
